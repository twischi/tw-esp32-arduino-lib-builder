...
# echo "OUT_PIO_Dist: $OUT_PIO_Dist"
...
cp -rf "$AR_OUT"/tools/esp32-arduino-libs "$OUT_PIO"/tools/  # from 'esp32-arduino-libs'       (BUILD output-libs)
#--------------------------------------------- 
...
EOL
# cat $OUT_PIO_Dist/pio-release-info.txt
...
#cat "$OUT_PIO_Dist"/pio-release-info.sh
